...
module.exports.run = async function ({ api, event, args }) {
  try {
    ...
    if (!response.data || !response.data.siddik || response.data.siddik.length === 0) {
      return api.sendMessage("ভিডিও লিস্ট আনতে সমস্যা হচ্ছে। পরে আবার চেষ্টা করুন।", event.threadID, event.messageID);
    }
    ...
    api.sendMessage(messageContent, event.threadID, (err, info) => {
      if (err) return console.error("ভিডিও লিস্ট পাঠাতে সমস্যা:", err);
    ...
    console.error("ভিডিও লিস্ট ফেচ করতে সমস্যা:", error);
    api.sendMessage("ভিডিও লিস্ট আনতে সমস্যা হচ্ছে। পরে আবার চেষ্টা করুন।", event.threadID, event.messageID);
  }
};
...
module.exports.handleReply = async function ({ api, event, handleReply }) {
  ...
  try {
    ...
    api.sendMessage("ভিডিও পাঠাতে সমস্যা হচ্ছে। পরে আবার চেষ্টা করুন।", event.threadID, event.messageID);
  }
};
